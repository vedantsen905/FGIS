            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 hover:border-green-300 transition-all duration-300 hover:shadow-md group">
                ...
                <p className="text-gray-700">
                  This covers the accidental loss or any damage to the insured vehicles as well as the cost of towing, transport & storage of vehicle after accident.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 hover:border-green-300 transition-all duration-300 hover:shadow-md group">
                ...
                <p className="text-gray-700">
                  This covers the loss or damage to the insured vehicle caused by fire and theft and also covers damage to third-party property.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 hover:border-green-300 transition-all duration-300 hover:shadow-md group">
                ...
                <p className="text-gray-700">
                  This covers the cost of damage to third-party property which may be caused by the insured party.
                </p>
              </div>
            </div>
          </div>
              ...
              <table className="min-w-full table-auto border-collapse">
                ...
                <tbody className="text-gray-800 text-md">
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Repair or replacement of vehicle in case of damage or theft.</td>
                    <td className="py-4 px-6">Cover to help repair or replace a vehicle in case of damage or theft.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Legal liability cover</td>
                    <td className="py-4 px-6">Cover for legal liability, including cover for legal costs, generally capped at $20 million or $30 million if the insured's vehicle causes damage to someone else's vehicle or property due to the fault of the policy holder.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Towing costs</td>
                    <td className="py-4 px-6">Cover for towing costs.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Trailer cover</td>
                    <td className="py-4 px-6">Trailer cover.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Emergency repairs</td>
                    <td className="py-4 px-6">Cover for emergency repairs to vehicle covered up to a specified limit including choice of repairer.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Modifications, options, or accessories</td>
                    <td className="py-4 px-6">Cover for damage to modifications, options, or accessories to your car due to accidental damage, fire, flood, storm, theft, attempted theft, vandalism, or a malicious act.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Windscreen repair or replacement</td>
                    <td className="py-4 px-6">The option to include excess free windscreen repair or replacement.</td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Hire car cover</td>
                    <td className="py-4 px-6">The option to include hire car cover following an accident or if stolen.</td>
                  </tr>
                </tbody>
              </table>
            </div>
