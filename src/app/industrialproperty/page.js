    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
        ...
        <section className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 transform transition-all hover:scale-[1.01] hover:shadow-xl">
        ...
        <section className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Stat 1 */}
            <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <div className="text-[#00AB9D] text-5xl font-bold mb-4 animate-counter" data-target="1030"></div>
              <p className="text-gray-600 mb-4">
                Manufacturing sales in New Zealand increased 1.5 percent year-on-year during the last quarter of 2019.
              </p>
              <div className="mt-4 px-4 py-2 bg-green-50 rounded-lg inline-block group-hover:bg-green-100 transition-colors"></div>
            </div>
            {/* Stat 2 */}
            <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <div className="text-[#00AB9D] text-5xl font-bold mb-4"></div>
              <p className="text-gray-600 mb-4">
              ...
              <div className="mt-4 px-4 py-2 bg-green-50 rounded-lg inline-block group-hover:bg-green-100 transition-colors">
                <p className="text-sm font-medium text-[#00AB9D] italic"></p>
              </div>
            </div>
            {/* Stat 3 */}
            <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
        ...
        <section className="space-y-12">
          <div className="bg-gradient-to-br from-green-50 to-white p-10 rounded-3xl shadow-xl">
            <h2 className="text-4xl font-bold text-[#00AB9D] mb-12 text-center">
              What are the types of covers available?
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              {/* First-Party Coverage */}
              <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 hover:border-green-300 transition-all duration-300 hover:-translate-y-2 group relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-[#00AB9D]"></div>
                ...
                <div className="flex flex-col h-full">
                  ...
                  <ul className="space-y-3 text-gray-700 flex-grow">
                    <li className="flex items-start">
                      ...
                      <span>Suitable for large sized, diverse businesses.</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <table className="min-w-full table-auto border-collapse">
                ...
                <tbody className="text-gray-800 text-md">
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Cover for loss or damage to physical business assets.</td>
                    <td className="py-4 px-6">Protection for material items of the business, such as buildings, contents, stock, plant and machinery.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Optional cover for architects, surveyors and consulting engineers fee clause, designation of property, escalation, omission to insure additions, alterations or extensions, temporary removal of stocks etc.</td>
                    <td className="py-4 px-6">Optional cover for suppliers' and customers premises extension.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold">Cover against damage from fire, floods, thefts or even accidents to employees or customers in the building.</td>
                    <td className="py-4 px-6">Cover against loss from consequential business interruption.</td>
                  </tr>
                </tbody>
              </table>
            </div>
