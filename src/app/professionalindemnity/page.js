        ...
        <section className="space-y-12">
          <div className="bg-gradient-to-br from-green-50 to-white p-10 rounded-3xl shadow-xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 hover:border-[#00AB9D] transition-all duration-300 hover:-translate-y-2 group relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#00AB9D] to-[#00AB9D]"></div>
                <div className="flex flex-col h-full">
                  ...
                  <div className="mt-6 pt-4 border-t border-green-100"></div>
                </div>
              </div>
              {/* First-Party Coverage 2 */}
              <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 hover:border-[#00AB9D] transition-all duration-300 hover:-translate-y-2 group relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#00AB9D] to-[#00AB9D]"></div>
                <div className="flex flex-col h-full">
                  <div className="bg-green-100/80 w-14 h-14 rounded-xl flex items-center justify-center mb-6 group-hover:bg-green-200 transition-colors">
