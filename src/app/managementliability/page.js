          ...
          <div className="bg-gradient-to-br from-green-50 to-white p-10 rounded-2xl shadow-lg">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 hover:border-green-300 transition-all duration-300 hover:shadow-md group">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Directors & Officers Liability</h3>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full table-auto border-collapse">
                ...
                <tbody className="text-gray-800 text-md">
                  ...
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6"> Cover for libel and slander.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6">Loss of documents.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6">Outside Directorship extension available.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6">Advancement of defense costs.</td>
                  </tr>
                  <tr className="border-b hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6">Cover the cost of investigating, defending, and settling claims by a third party.</td>
                  </tr>
                </tbody>
              </table>
            </div>
