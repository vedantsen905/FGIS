      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-16">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 transform transition-all hover:scale-[1.01] hover:shadow-xl">
            ...
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              ...
              <div className="mt-5 p-5 bg-gray-50 rounded-xl border border-gray-200">
                <p className="font-semibold text-gray-800 mb-3">Key considerations:</p>
        ...
        <section className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-green-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="text-[#00AB9D] text-4xl font-bold mb-4">$609,379,099</div>
            ...
            {/* Stat 3 */}
            <div className="bg-white border border-green-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="text-[#00AB9D] text-4xl font-bold mb-4">$46,288</div>
              <p className="text-gray-600 mb-4 text-lg">
        ...
        <section className="space-y-12">
          <div className="text-center">
            <h2 className="text-4xl font-bold text-[#00AB9D] mb-4">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:border-green-300 transition-all duration-300 hover:-translate-y-2 group">
              <div className="flex flex-col h-full">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <div className="text-sm font-medium text-[#00AB9D]">
          ...
          <div className="bg-[#f8fefc] border border-dashed border-[#00AB9D] rounded-xl p-5 max-w-3xl mx-auto text-center shadow-sm">
    <p className="text-gray-700 text-base md:text-lg font-medium">
      *Regardless of the type of coverage chosen, there are certain deductibles and limits of liability (or sum insured) that apply to the payout value.
    </p>
  </div>
        </section>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start p-4 bg-gray-50 rounded-xl">
                    <div className="bg-green-100 p-1.5 rounded-full mr-4 mt-1 flex-shrink-0">
                      <svg className="h-5 w-5 text-[#00AB9D]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
        ...
        <section className="grid md:grid-cols-2 gap-8">
          ...
          {/* Case Study */}
          <div className="relative overflow-hidden rounded-3xl shadow-2xl bg-[#00AB9D]">
            ...
            <div className="relative p-8 text-white h-full">
              <div className="flex flex-col h-full">
                ...
                <div className="space-y-4 text-white text-lg leading-relaxed flex-grow">
        ...
        <section className="bg-white p-10 rounded-3xl shadow-xl">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#00AB9D] mb-4">
                Why choose FG Insurance?
              </h2>
